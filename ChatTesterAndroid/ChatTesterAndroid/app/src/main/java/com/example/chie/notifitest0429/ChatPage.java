...
public class ChatPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chatView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d("ChatItem", "setOnItemClickListener");
                // your code here
            }
        });

                                                              //
        LinearLayout chatPageLayout = (LinearLayout) view.findViewById(R.id.chat_page);
        chatPageLayout.setOnTouchListener(new OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {

                Log.d("ChatPage", "setOnTouchListener");
                return false;
            }
        });
        ...
        refChat.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        List<ChatData>messages = new ArrayList<ChatData>();
                        ...
                        Log.d("ChatPage", "messages size: " + messages.size());
                        final MessageListAdapter adapter = new MessageListAdapter(getActivity(), R.layout.list_chat, messages);
                        //adapter.add("sample");
